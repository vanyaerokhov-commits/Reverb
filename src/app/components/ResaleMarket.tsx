  ...
  return (
    <div className="relative space-y-6">
      ...
      <div className="fixed inset-0 pointer-events-none opacity-5 z-0 overflow-hidden">
        <div className="absolute -left-48 top-1/4 w-[650px] h-[650px] rounded-full bg-[#242221]" />
        <div className="absolute right-1/4 -bottom-40 w-[850px] h-[850px] rounded-full bg-[#242221]" />
      </div>
            ...
            {sorted.map((ticket) => {
              ...
              return (
                <Link
                  ...
                  className="block"
                >
                  <Card className="bg-[#141111]/50 border-[#242221] overflow-hidden hover:border-[#E5381E]/40 transition-all group h-full">
                    {/* Image */}
                    ...
                    <div className="p-4">
                      ...
                      <div className="pt-3 border-t border-[#242221]">
                        <div className="w-full flex items-center justify-center gap-2 py-2 rounded-lg bg-[#E5381E]/10 group-hover:bg-[#E5381E]/20 transition-colors text-[#E5381E] text-sm font-semibold">
